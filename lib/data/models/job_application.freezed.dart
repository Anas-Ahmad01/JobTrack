...
class _$JobApplicationImpl implements _JobApplication {
  ...
  @override
  String toString() {
    return 'JobApplication(id: $id, userId: $userId, jobId: $jobId, jobTitle: $jobTitle, companyName: $companyName, location: $location, jobUrl: $jobUrl, status: $status, appliedAt: $appliedAt, notes: $notes, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
